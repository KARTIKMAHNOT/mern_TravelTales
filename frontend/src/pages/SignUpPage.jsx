...
import { Mail, Lock, LogIn, MapPinned, User, Loader2,Eye,EyeOff } from "lucide-react";
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen px-4 overflow-hidden bg-gradient-to-br from-black to-slate-900">
      ...
      <motion.div
        ...
        className="w-full max-w-md p-8 rounded-2xl bg-gradient-to-br from-zinc-900/80 to-zinc-800/80 backdrop-blur-lg border border-emerald-500/20 shadow-[0_0_30px_rgba(16,185,129,0.2)] relative overflow-hidden"
      >
        <motion.div
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          >
            ...
            <div className="relative group">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 rounded-xl bg-black/30 text-white border border-emerald-500/30 placeholder-emerald-300/40 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 hover:shadow-[0_0_15px_rgba(16,185,129,0.2)] transition-all duration-300"
              />
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.97 }}
            type="submit"
            className="w-full mt-4 py-3 rounded-xl bg-gradient-to-r from-emerald-500 to-emerald-600 text-black font-bold flex items-center justify-center gap-2 transition-all duration-300 shadow-[0_0_20px_rgba(16,185,129,0.3)] relative overflow-hidden"
          >
